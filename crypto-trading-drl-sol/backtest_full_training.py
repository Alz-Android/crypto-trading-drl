...
class FullTrainingBacktestRunner:
    ...
    def run_comprehensive_backtest(self, symbol='SOL'):
    ...
    def _generate_comprehensive_report(self, all_results, symbol):
        ...
        # Generate comparison with fast training
        self._compare_with_fast_training()
...
def main():
    ...
    try:
        ...
        all_results = backtester.run_comprehensive_backtest('SOL')
